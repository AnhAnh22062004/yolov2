...
def parse_args():
    ...
    parser.add_argument("--data_train", type=str, default='../../../Dataset/WIDER/WIDER_train', help='Please enter path')
    parser.add_argument("--data_test", type=str, default='../../../Dataset/WIDER/WIDER_test', help='Please enter path')
